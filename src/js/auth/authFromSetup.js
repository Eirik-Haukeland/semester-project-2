...
export default (type) => {
  const dialogElement = document.getElementById('user-menu')

  dialogElement.innerHTML = `
    <form id="auth-action-form">
      <fieldset class="col-start-4 flex justify-content-center content-center w-min self-start [500px]:justify-self-end overflow-clip max-[500px]:col-span-4">
        ...
        <label for="auth-action-register" class="peer-checked/auth-action-register:bg-pink-900 peer-checked/auth-action-register:text-white p-2 bg-gray-200 whitespace-nowrap font-bold rounded-l-md border-2 border-pink-900">Newest item</label>
        <input type="radio" name="auth-action-radio" id="auth-action-login" class="peer/auth-action-login sr-only" value="login">
        <label for="auth-action-login" class="peer-checked/auth-action-login:bg-pink-900 peer-checked/auth-action-login:text-white p-2 bg-gray-200 whitespace-nowrap font-bold rounded-r-md border-2 border-pink-900">Ends soon</label>
      </fieldset>
      <fieldset class="flex flex-col justify-content-center content-center">
        ...
        <div class="flex flex-col-reverse">
          ...
          <input type="text" name="auth-action-name" id="auth-action-name">
        ...
        <div class="flex flex-col-reverse">
          ...
          <input type="text" name="auth-action-email" id="auth-action-email">
        ...
        <div class="flex flex-col-reverse">
          ...
          <input type="text" name="auth-action-picture" id="auth-action-picture">
        ...
        <div class="flex flex-col-reverse">
          ...
          <input type="text" name="auth-action-password" id="auth-action-password">
        ...
        <div class="flex flex-col-reverse">
          ...
          <input type="text" name="auth-action-repeat-password" id="auth-action-repeat-password">
          <label for="auth-action-repeat-password" class="whitespace-nowrap font-bold">Repeat Password</label>
        </div>
      </fieldset>
      <button id="auth-action-button" class="justify-self-center">Register</button>
    </form>
  `
